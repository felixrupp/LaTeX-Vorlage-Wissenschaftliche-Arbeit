...
% biblatex einbinden -----------------------------------------------------------------------
\usepackage[backend=biber, hyperref=true, backref=true, backrefstyle=all+, citestyle=authoryear-ibid-brack, bibstyle=authoryear, sorting=nyt, dashed=false, urldate=long, natbib=true]{biblatex}
